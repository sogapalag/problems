...
// first require pref k+1 > suff k, \A k. <=>  pref>suff for k=n/2. since the delta is min then.
// then rephrase A_i = 1 + x_1 + x_2 +.., i.e. x_i = Ai-A_{i-1}
// x_1 + x_.. <= n, x_1 >= Z * x_..
// once x_.. decided, #choice of x_1 is decided
// so dp[s] = #s = (Z+1)*x_..
void solve() {
    int n;
    cin >> n >> MOD[0];
